...
namespace AppCore.Services.Articles
{
    ...
    public interface IArticleService : IService<Article>
    {
        ...
        Task<IEnumerable<Article>> GetArticlesByFeedAsync(int feedId);
        ...
        Task<Article?> MarkAsReadAsync(int articleId);
        ...
        /// <param name="articleId">ID of the article</param>
        /// <returns>The updated article</returns>
        Task<Article?> MarkAsUnreadAsync(int articleId);
        ...
        Task<Article?> FetchFullContentAsync(int articleId);
        ...
        Task<IEnumerable<Article>> SearchArticlesAsync(string searchText, int? feedId = null);
    }
}
